...
<body>
	...
	<div class="main main-raised">
			...
			<div class="row" id="row">
				...
				<div class="col-md-3" id="col2">
					...
					<div class="client_img">
						...
						<p class="text-muted">클라이언트에 대한 소개 어쩌구 저쩌구 어쩌구 저쩌구!!!
			...
			<c:if test="${userdto.getUser_type() eq '투자자' }">
				<div class="button_container" style="text-align: center;">
					<button class="btn btn-info btn-lg"
						style="display: inline-block; width: 150px;">투자하기</button>
				</div>
			</c:if>

			<c:if test="${userdto.getUser_type() eq '파트너스' }">
				<div class="partners_button">
					<button id="partners" class="btn btn-rose btn-lg"
						style="display: inline-block; width: 150px;">지원하기</button>
				</div>
			</c:if>
        ...
        <div class="button_container" style="text-align: center;">
           <button class="btn btn-info btn-lg" id="chkbt" style="display: inline-block; width: 150px;"
            onclick="location.href='admin_changeproject.do?board_no=${dto.board_no }&project_state=<jsp:getProperty
											property="project_state" name="dto"/>'">승인하기</button>
       	   <button class="btn btn-default btn-lg" id="chkbt2" style="display: inline-block; width: 150px;"
       	   onclick="location.href='admin_deleteproject.do?board_no=${dto.board_no }&project_state=<jsp:getProperty
				property="project_state" name="dto"/>'">폐기하기</button>
        </div>
        </c:if>
