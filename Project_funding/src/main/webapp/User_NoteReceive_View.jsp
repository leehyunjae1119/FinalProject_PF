			...
			<div class="row">
				...
				<br>
					<div class="col col-md-15">
						...
						<input type="button" class="btn btn-warning" value="삭제하기" id="delete"
							style="float: right;"/>			
						<form action="muldel.do?message_no=${MessageView_message_no }" method="post">
						<c:if test="${MessageView.message_state eq '안읽음' }">
							<input type="hidden" value=""/>
						</c:if>
						<table class="table table-condensed table table-hover" style="text-align: center;">
