									...
									<div class="project">
										<div class="row">
											<div class="col-sm-2" style="float: left; padding-left: 35px; padding-top: 25px;">
												<img src="resources/assets/img/faces/avatar.jpg" class="rounded-circle img-fluid" alt="circle" style="height: 80px; width: 80px;" id="img3"> <br>
												<div>
											...
											<div class="col-sm-6" style="wedth: 100px;">
												<h3 id="x">
													<a onclick="window.open('partners_popup.do?user_id=${dto.user_id }','Parters Profile','width=1040,height=540,location=no,status=no,scrollbars=yes');" style="color: skyblue;"><strong>${dto.user_id } &nbsp</strong></a>
												</h3>
				...
				<div class="modal-content">
					...
					<form action="message_insert.do?page=1" method="post">
						...
						<div class="modal-body">
							...
							<!-- 쪽지 내용 작성하는 부분 -->
							<h4>
								<b id="min">받는사람&nbsp;</b> <input type="text" class="modal-title" name="reader" style="border: none;" readonly="readonly" />
							</h4>
							<h4>
								<b>내용&nbsp;</b>
							</h4>
