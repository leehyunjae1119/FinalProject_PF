...
<script type="text/javascript" src="resources/searchPaging/pasing.js?ver=1"></script>
</c:if>


 
  <c:if test="${board_title eq null}">
 <script type="text/javascript" src="resources/detail_paging/pasing.js?ver=1"></script>
	</c:if>
	...
	<div class="col-md-12" style="height: 170px;">
		...
		<div class="col-md-2" id="list_col">
			<div class="list_container2">
				...
				<!-- detail 페이징 값 -->
				<input type="hidden" id="totalCount_dtail" value='${totalCount_dtail }'> 
