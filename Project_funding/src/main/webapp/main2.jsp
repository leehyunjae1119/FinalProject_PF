      ...
      <div class="container">
        <div class="number_container">
         <div class="number">			
        	 ...
        	 <h3><b>프로젝트 금액</b></h3>
       		 <h3><b>프로젝트 & 프리랜서</b></h3>
        	 <h2><span class="counter">${totalCount}</span></h2>
       		 <h2><span class="counter">${CountCoin}</span></h2>
       		 <h2><span class="counter">12345</span></h2>
    	</div>
       ...
       <div class="useway">
       		<div class="title">
       			<h3 style="text-align: center;"><b>이렇게 이용하세요!</b></h3>
       		</div>
       		...
       		<div class="useway2">
       			<div class="use2">
       				<img src="resources/assets/img/client.png"  class="rounded-circle img-fluid" />
       			</div>
       		...
       		<div class="useway3">
       			<div class="use3">
       				<img src="resources/assets/img/invest.png"  class="rounded-circle img-fluid" />
       			</div>
       	...
       	<div class="graph_container">
       		<div class="title">
       			<h3 style="margin-bottom: 70px;"><b>투자자 현황</b></h3>
       		</div>
       		...
       		<div class="chart_content">
				<div class="wrapper"><div class="chartjs-size-monitor" style="position: absolute; left: 0px; top: 0px; right: 0px; bottom: 0px; overflow: hidden; pointer-events: none; visibility: hidden; z-index: -1;"><div class="chartjs-size-monitor-expand" style="position:absolute;left:0;top:0;right:0;bottom:0;overflow:hidden;pointer-events:none;visibility:hidden;z-index:-1;"><div style="position:absolute;width:1000000px;height:1000000px;left:0;top:0;"></div></div><div class="chartjs-size-monitor-shrink" style="position:absolute;left:0;top:0;right:0;bottom:0;overflow:hidden;pointer-events:none;visibility:hidden;z-index:-1;"><div style="position:absolute;width:200%;height:200%;left:0; top:0;"></div></div></div>
					<canvas id="chart-0" width="900" height="400" style="display: block; width: 900px; height: 400px;" class="chartjs-render-monitor"></canvas>
				</div>
<!-- 				<div class="toolbar"> -->
...
<!-- 				</div> -->
       	...
       	<div class="project_container">
       		<div class="popular_project">
       			...
       			<div class="col-md-4" style="display:inline-block; max-width: 33%;">
    <div class="card">
