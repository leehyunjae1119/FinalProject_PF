$(function(){
	...
	if(totalPage > 10){
	if(startPage > 1){
		$("#pasing").append("<li class=''><a href='project_list_money.do?page=1' aria-label='Previous'><span aria-hidden='true'>&laquo;</span></a></li>");
	}else{
		$("#pasing").append("<li class='disabled'><a href='#' aria-label='Previous'><span aria-hidden='true'>&laquo;</span></a></li>");
	}
	}
	if(page > 1){
		$("#pasing").append("<li class=''><a href='project_list_money.do?page="+(page - 1)+"' aria-label='Previous'><span aria-hidden='true'>&lang;</span></a></li>");
	}else{
	...
	for(var iCount = startPage; iCount <= endPage; iCount++) {
		if (iCount == page) {
	       $("#pasing").append("<li class='active'><a href='#'>"+iCount+"<span class='sr-only'></span></a></li>");
	    	...
	    	$("#pasing").append("<li class=''><a href='project_list_money.do?page="+iCount+"'>" + iCount + "<span class='sr-only'></span></a></li>");
	    }
	}
	
	if(page < totalPage){
		$("#pasing").append("<li class=''><a href='project_list_money.do?page="+(Number(page)+1)+"' aria-label='Next'><span aria-hidden='true'>&rang;</span></a></li>");
	}else{
	...
	if(totalPage >10){
	if(endPage < totalPage){
		$("#pasing").append("<li class=''><a href='project_list_money.do?page="+totalPage+"' aria-label='Next'><span aria-hidden='true'>&raquo;</span></a></li>");
	}else{
